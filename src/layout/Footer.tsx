        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/favorites" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Favoris
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400 text-sm">Email: contact@library.com</li>
              <li className="text-gray-400 text-sm">Tél: +33 1 23 45 67 89</li>
            </ul>
          </div>
        </div>
